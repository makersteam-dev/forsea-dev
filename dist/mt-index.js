...
(() => {
  ...
  window.Webflow.push(() => {
    ...
    const btnSvgPause = document.querySelector(".video-btn-svg-pause");
    const dummyBtnSvg = document.querySelector(".video-btn-svg-dummy");
    video.addEventListener("click", () => {
      if (video.paused) {
        ...
        if (dummyBtnSvg !== null) {
          dummyBtnSvg.style.display = "none";
        }
      } else {
        video.pause();
        if (btnSvg !== null) {
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=mt-index.js.map
