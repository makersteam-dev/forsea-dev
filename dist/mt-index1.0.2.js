  ...
  window.Webflow.push(() => {
    ...
    whoWeAreWrappers.forEach((wrapper) => {
      ...
      sectionSpans.forEach((span, index) => {
        ...
        const tl2 = gsapWithCSS.timeline({ paused: true, defaults: { duration: 0.2 } });
        tl2.set(span, { zIndex: 3 });
        tl2.to(relatedImages, { opacity: 1, ease: "power4.out" });
        tl2.fromTo(sectionHeading, { color: "#000000" }, { color: "rgba(0, 0, 0, 0.2)" }, "<");
    ...
    const wrapElement = document.querySelector(".theres-something-video-wrap");
      ...
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          if (shouldPlay) {
            video.play();
            if (wrapElement !== null) {
              wrapElement.style.cursor = "none";
            }
          }
        } else {
          video.pause();
          if (wrapElement !== null) {
            wrapElement.style.cursor = "auto";
          }
        }
      });
    };
    ...
    gsapWithCSS.matchMedia().add("(min-width: 992px)", function() {
      const tl2 = gsapWithCSS.timeline({
        scrollTrigger: {
          ...
          scrub: true,
          // Enables smooth scrubbing effect during scroll
          pin: true,
          // Pins the trigger element during animation
          start: "top top",
          // Start of the trigger element relative to viewport
          end: "+=700%",
          // End of the trigger element relative to viewport
          markers: false
          // Set to true to display markers for debugging
        }
      });
      ...
      frames.forEach(function(frame, index) {
        gsapWithCSS.set(frame, {
          translateZ: "-100rem",
          // Move element away from viewer (negative Z-axis) for a 3D effect
          filter: "blur(20px)",
          // Apply blur effect
          opacity: 0
        ...
        tl2.to(
          frame,
          {
            ...
            // Easing function
            translateZ: "77rem"
            // Set different Z value for the 6th element
          },
          "<+=" + index * 0.4
          // Animation stagger based on index
        );
        tl2.to(
          frame,
          {
        ...
        tl2.to(
          frame,
          {
            ...
            // Animation duration
            filter: "blur(0px)"
            // Set blur to 0 (no blur)
          },
          "<+=1.8"
          // Animation delay after the previous animation
        );
      });
    });
  });
...
gsap/ScrollTrigger.js:
  ...
  *)
*/
//# sourceMappingURL=mt-index1.0.2.js.map
